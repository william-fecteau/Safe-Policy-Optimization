...
import numpy as np
import torch
from safepo.common.env import (make_ma_mujoco_env, make_ma_multi_goal_env,
                               make_sa_isaac_env, make_sa_mujoco_env)
from safepo.common.model import ActorVCritic
from safepo.utils.config import (multi_agent_goal_tasks,
...
def eval_single_agent(eval_dir, eval_episodes):
    ...
    eval_env, obs_space, act_space = make_sa_mujoco_env(num_envs=config['num_envs'], env_id=env_id, seed=None, render_mode="human")
...
def benchmark_eval():
    seed_path = "./runs/single_agent_exp/SafetyHalfCheetahVelocity-v1/ppo/seed-000-2025-04-14-13-52-05"
    eval_episodes = 3
